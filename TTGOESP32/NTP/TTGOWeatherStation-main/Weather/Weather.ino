...
const char* ssid     = "leecw_PC";       ///EDIIIT
const char* password = "Qazxsw1234"; //EDI8IT
String town="Tainan";              //EDDIT
String Country="TW";                //EDDIT
const String endpoint = "http://api.openweathermap.org/data/2.5/weather?q="+town+","+Country+"&units=metric&APPID=";
const String key = "d5e020566471643288260dcd3a45f14a"; /*EDDITTTTTTTTTTTTTTTTTTTTTTTT                      */
