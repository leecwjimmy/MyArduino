...
const long interval = 5;           // interval at which to blink (milliseconds)  main loop time 5ms
...
// for arduino UNO 	DDRD = 0x00;  //設定埠D為輸入模式
	pinMode(P_ss,OUTPUT);
 //       PORTB7 = LOW;
  ledState = 0;
...
//*******************************************
 // Serial.begin(115200);  // 開啟UART 鮑率為 115200
  ...
  SPI.setClockDivider(SPI_CLOCK_DIV128); // SPI clock
